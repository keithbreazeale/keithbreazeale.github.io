...
Course Outcome 3: I Designed and Evaluated computing solutions that solve a given problem using algorithmic principles and computer science practices and standards appropriate to its solution while managing the trade-offs involved in design choices by the completion of the second application which was for the Algorithms and Data Structures Application. I was able to enhance the existing code to work with new algorithms for the displaying of bids by ID, Amount, searching for bids by ID, and searching for bids by amount within a specified range. While the amount of code near doubled in size due to the enhancements mentioned, no impact or lag was noticed when testing the new enhancements. This leads to no real performance impact to the user.
